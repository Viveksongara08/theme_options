...
function woo_wc_search_form( $form ) {
    ...
    <input type="search" results=5 autosave="'. esc_url(home_url( '/' )) .'" class="input-text form-control" placeholder="'. esc_attr__( 'Search Products', 'woothemes' ) .'" value="' . get_search_query() . '" name="s" id="s" />
    <input style="display:none;"  type="submit" class="button" id="searchsubmit" value="'. esc_attr__( 'Search', 'woothemes' ) .'" />
